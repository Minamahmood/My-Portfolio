                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 float-left">
                                        <div className="about-right">
                                            <p>I am a web developer with good knowledge of front-end techniques. I recently earned a certificate in full-stack development from Berkeley Bootcamp with newly developed skills in javascript, CSS, React.js, and responsive web design. I love structure and order and I also stand for quality. I love spending time fixing little details and optimizing web apps. I also like working in a team.</p>
